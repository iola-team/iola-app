...
const dataStore = (() => {
  ...
  // const mockPhotos = ['https://www.mrsras.com/uploads/7/0/8/5/7085982/2305284_orig.jpg'];
  const getRandomDate = () => (
    moment(faker.date.between(moment().subtract(3, 'hours').format(), moment())).unix()
  );
    ...
    users: [
      {
        ...
        photos: mockPhotos.map((url, id) => ({
          ...
          // caption: faker.lorem[sampleSize(['paragraphs'], 1)](),
